...
class EnhancedApiService {
  ...
  inventory = {
    ...
    getGoldPurityOptions: () => this.getCached(
    ...
    getItems: (filters?: Record<string, any>) => this.getCached(
      'api/inventory/items',
      { params: filters },
      { ttl: 2 * 60 * 1000 }
    ),
    ...
    getItem: (id: number) => this.getCached(
    ...
    getLowStockItems: () => this.getCached(
    ...
    getExpiringItems: (days?: number) => this.getCached(
  ...
  customers = {
    ...
    getCustomers: (filters?: Record<string, any>) => this.getCached(
      'api/customers',
      { params: filters },
      { ttl: 60 * 1000 }
    ),
    ...
    getCustomer: (id: number) => this.getCached(
      `api/customers/${id}`,
      {},
      { ttl: 5 * 60 * 1000 }
    ),
    ...
    getAgingReport: (filters?: Record<string, any>) => this.getCached(
  ...
  invoices = {
    ...
    getInvoices: (filters?: Record<string, any>) => this.getCached(
      'api/invoices',
      { params: filters },
      { ttl: 60 * 1000 }
    ),
    ...
    getInvoice: (id: number) => this.getCached(
      `api/invoices/${id}`,
      {},
      { ttl: 5 * 60 * 1000 }
    ),
    ...
    getTemplate: (id: number) => this.getCached(
