    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white dark:bg-gray-800">
      ...
      <div v-if="auditLog" class="space-y-4">
        ...
        <div v-if="auditLog.old_values">
          ...
          <pre class="bg-gray-50 dark:bg-gray-700 p-3 rounded text-xs overflow-x-auto">{{ JSON.stringify(auditLog.old_values, null, 2) }}</pre>
        </div>
        ...
        <div v-if="auditLog.new_values">
          ...
          <pre class="bg-gray-50 dark:bg-gray-700 p-3 rounded text-xs overflow-x-auto">{{ JSON.stringify(auditLog.new_values, null, 2) }}</pre>
        </div>
      </div>
