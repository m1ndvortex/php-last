      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex justify-between items-center py-1">
            ...
            <span class="text-sm text-gray-900 dark:text-white font-mono">
              {{ formatCurrency(reportData.operating_activities.working_capital_changes) }}
            </span>
          </div>
          
          <div class="flex justify-between items-center py-2 border-t border-gray-200 dark:border-gray-700 font-medium">
      ...
      <div>
        ...
        <div class="space-y-2">
          ...
          <div class="flex justify-between items-center py-1">
            ...
            <span class="text-sm text-gray-900 dark:text-white font-mono">
              {{ formatCurrency(reportData.financing_activities.equity_transactions) }}
            </span>
          </div>
