      ...
      <div>
        ...
        <div class="mb-6">
          ...
          <div class="space-y-2">
            ...
            <div
              class="flex justify-between items-center py-1 border-t border-gray-200 dark:border-gray-700 font-medium"
            >
              ...
              <span class="text-sm text-gray-900 dark:text-white font-mono">
                {{
                  formatCurrency(
                    reportData.assets.current_assets.reduce(
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="text-sm text-gray-900 dark:text-white font-mono">
                {{
                  formatCurrency(
                    reportData.assets.fixed_assets.reduce(
                      (sum, asset) => sum + asset.balance,
                      0,
                    ),
                  )
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="text-sm text-gray-900 dark:text-white font-mono">
                {{
                  formatCurrency(
                    reportData.liabilities.current_liabilities.reduce(
          ...
          <div class="space-y-2">
            ...
            >
              ...
              <span class="text-sm text-gray-900 dark:text-white font-mono">
                {{
                  formatCurrency(
                    reportData.liabilities.long_term_liabilities.reduce(
                      (sum, liability) => sum + liability.balance,
                      0,
                    ),
                  )
    ...
    >
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <CheckCircleIcon
            v-if="reportData.totals.is_balanced"
          ...
          >
            {{
              reportData.totals.is_balanced
                ? $t("accounting.balance_sheet_balanced")
                : $t("accounting.balance_sheet_unbalanced")
            }}
          </p>
        </div>
        <div
