      ...
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tfoot class="bg-gray-50 dark:bg-gray-700">
          <tr>
            ...
            <td
              class="px-6 py-3 text-sm font-bold text-right text-gray-900 dark:text-white"
            >
          ...
          <tr v-if="!reportData.totals.is_balanced">
            <td
              colspan="3"
              class="px-6 py-3 text-sm font-medium text-red-600 dark:text-red-400"
            >
              {{ $t("accounting.difference") }}
            </td>
            <td
              colspan="2"
              class="px-6 py-3 text-sm font-bold text-right text-red-600 dark:text-red-400"
            >
    ...
    >
      <div class="flex items-center">
        ...
        >
          {{
            reportData.totals.is_balanced
              ? $t("accounting.trial_balance_balanced")
              : $t("accounting.trial_balance_unbalanced")
          }}
        </p>
      </div>
    </div>
