    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="border-t-2 border-gray-300 dark:border-gray-600 pt-6">
        ...
        <div class="flex justify-between items-center text-sm text-gray-600 dark:text-gray-400">
          ...
          <span class="font-mono">{{ formatPercentage(reportData.gross_margin) }}</span>
        </div>
      </div>
      ...
      <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
          ...
          <div class="text-2xl font-bold text-blue-900 dark:text-blue-100 font-mono">
            {{ formatCurrency(reportData.revenue.total) }}
          </div>
        </div>
        ...
        <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-4">
          ...
          <div class="text-2xl font-bold text-red-900 dark:text-red-100 font-mono">
            {{ formatCurrency(reportData.expenses.total) }}
          </div>
        </div>
