<template>
  <div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-2">
            <span class="text-sm text-gray-500 dark:text-gray-400">
              {{ $t('common.total') }}: {{ accountingStore.filteredTransactions.length }}
            </span>
          </div>
        </div>
      </div>
      ...
      <div v-else-if="accountingStore.filteredTransactions.length === 0" class="p-12 text-center">
      ...
      <div v-else class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="transaction in accountingStore.filteredTransactions" :key="transaction.id">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex items-center justify-end space-x-2">
                  ...
                  >
                    {{ transaction.is_locked ? $t('accounting.unlock') : $t('accounting.lock') }}
                  </button>
                </div>
              </td>
            </tr>
