<template>
  <div class="inventory-report">
    ...
    <div v-if="report.data" class="space-y-6">
      ...
      <div
        v-if="
          report.data.low_stock_items && report.data.low_stock_items.length > 0
        "
      >
        ...
        <div class="overflow-x-auto">
          ...
          >
            <thead class="bg-red-50 dark:bg-red-900/20">
              <tr>
                <th
                  class="px-6 py-3 text-left text-xs font-medium text-red-500 dark:text-red-300 uppercase"
                >
                  {{ $t("reports.sku") }}
                </th>
                <th
            ...
            >
              <tr v-for="movement in report.data.movements" :key="movement.id">
                ...
                <td
                  ...
                  :class="getQuantityChangeClass(movement.quantity_change)"
                >
      ...
      <!-- Reorder Items -->
      <div
        v-if="report.data.reorder_items && report.data.reorder_items.length > 0"
      >
        <h4
          class="text-md font-medium text-orange-700 dark:text-orange-300 mb-4"
        >
        ...
        <div class="overflow-x-auto">
          ...
          >
            <thead class="bg-orange-50 dark:bg-orange-900/20">
              <tr>
                <th
                  class="px-6 py-3 text-left text-xs font-medium text-orange-500 dark:text-orange-300 uppercase"
                >
                  {{ $t("reports.sku") }}
                </th>
                <th
