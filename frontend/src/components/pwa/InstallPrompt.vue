      ...
      >
        <div class="max-w-7xl mx-auto px-4 py-3">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3" :class="{ 'rtl:space-x-reverse': isRTL }">
    ...
    >
      ...
      >
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click="closeInstallModal"></div>
          ...
          <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            <div>
              <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 dark:bg-blue-900">
                <DevicePhoneMobileIcon class="h-6 w-6 text-blue-600 dark:text-blue-400" />
              </div>
            ...
            <div class="mt-6">
              ...
              <ul class="space-y-2">
                <li class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                  <CheckIcon class="h-4 w-4 text-green-500 mr-2" :class="{ 'rtl:mr-0 rtl:ml-2': isRTL }" />
            ...
            <div v-if="installInstructions" class="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-2">
                {{ t('pwa.install.instructions') }}
              </h4>
              <div class="text-sm text-gray-600 dark:text-gray-300" v-html="installInstructions"></div>
            </div>
